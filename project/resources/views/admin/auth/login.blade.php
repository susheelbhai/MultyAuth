...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 11:17:30 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link href="{{ env('STORAGE_URL') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="{{ env('STORAGE_URL') }}/css/style.css" rel="stylesheet">
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="index.html" class="logo"><img src="{{ env('STORAGE_URL') }}/images/logo/logo-full.png" alt="" class="width-230 light-logo"></a>
											<a href="index.html" class="logo"><img src="{{ env('STORAGE_URL') }}/images/logo/logofull-white.png" alt="" class="width-230 dark-logo"></a>
										</div>
...
***********************************-->
<!-- Required vendors -->
<script src="{{ env('STORAGE_URL') }}/vendor/global/global.min.js"></script>
<script src="{{ env('STORAGE_URL') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="{{ env('STORAGE_URL') }}/js/deznav-init.js"></script>
 <script src="{{ env('STORAGE_URL') }}/js/custom.js"></script>
<script src="{{ env('STORAGE_URL') }}/js/demo.js"></script>
<script src="{{ env('STORAGE_URL') }}/js/styleSwitcher.js"></script>
</body>
